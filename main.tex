...
\vspace*{2cm}
\includegraphics[width=.3\textwidth]{build-4-rooms.PNG}
%
\hspace*{3cm}
...
\vspace*{2cm}
\includegraphics[width=.3\textwidth]{build-4-rooms-left.PNG}
%
\hspace*{3cm}
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1.2cm,
                    semithick,  baseline=(current bounding box.center)]
...
\vspace*{2cm}
\includegraphics[width=.3\textwidth]{build-4-rooms-up-right.PNG}
...
\vspace*{2cm}
\includegraphics[width=.3\textwidth]{build-4-rooms-up-left.PNG}
%
\hspace*{3cm}
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1.2cm,
                    semithick,  baseline=(current bounding box.center)]
...
\begin{frame}
  ...
  \begin{tikzpicture}
   \node at (1,1) (pic) 
   {\includegraphics[width=.4\textwidth]{robot_quest.png}};
   \node[left = of pic] (text) {this is a reobot};
   \draw[->] (pic) -- (text);
  \end{tikzpicture}
\end{frame}
\end{document}
